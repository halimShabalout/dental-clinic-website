...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  if (lang === "ar") {
    return {
      ...
      keywords: ["خدمات تقويم الأسنان", "تقويم شفاف مكة", "تقويم أسنان أسلاك", "خطط علاج شخصية", "دكتور أيمن زين"],
      alternates: { canonical: "/ar/services" },
      openGraph: {
        title: "خدمات تقويم الأسنان – د. أيمن زين",
        description: "استكشف خدماتنا في التقويم الشفاف والأسلاك وخطط العلاج المخصصة لتحسين ابتسامتك.",
        url: "/ar/services",
  ...
  return {
    ...
    keywords: ["Orthodontic services", "Clear aligners Mecca", "Braces Mecca", "Personalized treatment plans", "Dr Ayman Zain"],
    alternates: { canonical: "/en/services" },
    openGraph: {
      title: "Orthodontic Services – Dr. Ayman Zain",
      description: "Explore our clear aligners, braces, and customized treatment plans to improve your smile.",
      url: "/en/services",
      siteName: "Dr. Ayman Zain Orthodontics",
      type: "website",
    },
