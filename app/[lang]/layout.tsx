...
export async function generateMetadata({
  ...
  if (lang === "ar") {
    return {
      title: {
        default: "أفضل طبيب تقويم الأسنان في مكة - الدكتور أيمن زين",
        template: "%s | أفضل طبيب تقويم الأسنان في مكة – الدكتور أيمن زين",
      },
      description:
      ...
      openGraph: {
        title: "أفضل طبيب تقويم الأسنان في مكة - الدكتور أيمن زين",
        description:
